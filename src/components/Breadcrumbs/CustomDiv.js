      ...
      <div>
        {activeTab === 'Usage' && (
          <table>
            ...
            <tbody>
              <tr>
                <td>Alligo breadcrumbs are typically used on Storyblok content pages, campaign pages, the product listing pages, as well as the product detail pages.

                  The breadcrumbs should be implemented below the header in a container div
                </td>
              </tr>
            </tbody>
          </table>
        ...
        {activeTab === 'Resources' && (
          <table>
            ...
            <tbody>
              <tr>
                <td>
                  <a href="https://www.figma.com/design/42MgqJjV9vfplwQnrUB62r/ALLIGO-Design-System?node-id=1986-64264&t=ACykbVo4oGRrbk3l-1" target="_blank" class="figma-link-container">
